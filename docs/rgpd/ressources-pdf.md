...
Cette page regroupe les PDF liés au module RGPD.

Sélectionne un document dans la liste pour l'afficher dans la visionneuse.

<div class="pdf-library" data-pdf-library>
  <section class="pdf-viewer-panel" aria-label="Visionneuse PDF">
    <div class="pdf-viewer-toolbar">
      <h2 id="pdf-viewer-title">Travail et données personnelles - fiches de synthèse</h2>
  ...
  <aside class="pdf-list-panel" aria-label="Liste des PDF">
    ...
    >
      ...
      <span class="pdf-list-item-meta">Fiches de synthèse CNIL - 05/06/2025</span>
    </button>
    <button
      class="pdf-list-item"
      type="button"
    ...
    >
      ...
      <span class="pdf-list-item-meta">Fiches de synthèse CNIL - 09/04/2025</span>
    </button>
    <button
      class="pdf-list-item"
      type="button"
...
!!! note "Ajout de nouveaux PDF"
    Les fichiers PDF sont stockés dans `docs/assets/img/RGPD`. Pour les afficher dans cette page, il suffit d'ajouter une entrée dans la liste des documents.
